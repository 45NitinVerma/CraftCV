...
const ResumeBuilder = () => {
	...
	const chageResumeVisibility = async () => {
		try {
	...
	const saveResume = async () => {
		try {
			...
			// console.log("Image before upload:", resumeData.personal_info.image);
				...
				<div className="grid lg:grid-cols-12 gap-8">
					...
					<div className="relative lg:col-span-5 rounded-lg overflow-hidden">
						<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1">
							...
							<hr
								className="absolute top-0 left-0 h-1 bg-gradient-to-r from-green-500 to-gray-600 transition-all duration-2000"
								style={{
									width: `${
						...
						<div className="relative w-full">
							...
							<div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
								{resumeData.public && (
									<button
										onClick={handleShare}
										className="flex items-center p-2 px-4 gap-2 text-xs bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-2xl ring-blue-300 hover:ring transition-colors"
									>
