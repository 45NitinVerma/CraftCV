	...
	return (
		<div className="relative">
			<button
				...
				className="flex items-center gap-1 text-sm text-purple-600 bg-gradient-to-br from-pink-50 to-purple-100 ring-purple-300 hover:ring transition-all px-3 py-2 rounded-lg"
			>
				<Palette size={16} />
